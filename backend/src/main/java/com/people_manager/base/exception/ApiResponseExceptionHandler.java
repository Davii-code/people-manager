package com.people_manager.base.exception;
...
public abstract class ApiResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<MessageResponse> handleAuthorizationDeniedException(AuthorizationDeniedException ex){
        var messageResponse =  mountMessageResponse(HttpStatus.FORBIDDEN, ApiErrorEnum.ACCESS_DENIED);
    ...
    @ExceptionHandler(com.people_manager.base.exception.DataException.class)
    ...
    @ExceptionHandler(com.people_manager.base.exception.BusinessException.class)
