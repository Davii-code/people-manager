...
import com.people_manager.base.exception.FilterChainExceptionHandler;
import com.people_manager.base.security.impl.AuthenticationProvider;
import com.people_manager.base.security.impl.JwtAuthenticationFilter;
import com.people_manager.base.security.impl.LogoutService;
...
public abstract class ApiSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        var freeAccessArray = freeAccess.toArray(new String[0]);

        var freeAccessGetList = new ArrayList<>(getCustomFreeAccessGet());
        var freeAccessGetArray = freeAccessGetList.toArray(new String[0]);
